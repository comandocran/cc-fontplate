...
var Baseliner = function(options) {
  ...
  this.overlay = null;
  this.showText = document.createTextNode("Show vertical rhythm");
  this.hideText = document.createTextNode("Hide vertical rhythm");
  ...
  this.refresh = function(value) {
    ...
    baseliner.grid_size.style.color = "green";
...
//    action.style.top = '24px';
//    action.style.left = '24px';
...
//    action.style.decorationText = 'underline';
